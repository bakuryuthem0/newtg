jQuery(document).ready(function($){
	...
	function loadNewContent(newSection, bool) {
		setTimeout(function(){
			...
			var section = $('<section class="cd-section overflow-hidden '+newSection+' scrollable"></section>').appendTo(mainContent);
			//load the new content from the proper html file
			$('.contLoading').fadeIn('fast');
			section.load(newSection, function(event){
				$('.contLoading').fadeOut('fast');
